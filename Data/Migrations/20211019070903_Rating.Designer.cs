...
namespace FIT5032_Assignment_2.Data.Migrations
{
    ...
    [Migration("20211019070903_Rating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FIT5032_Assignment_2.Models.Files", b =>
                {
            ...
            modelBuilder.Entity("FIT5032_Assignment_2.Models.NFTsDonated", b =>
                {
                    b.Property<string>("Tx_Hash")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Bought_Tx")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Donor_Address")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("Bought_Tx");

                    b.HasIndex("OrgId");

                    b.ToTable("NFTsDonated");
                });
            ...
            modelBuilder.Entity("FIT5032_Assignment_2.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FIT5032_Assignment_2.Models.NFTsDonated", b =>
                {
                    b.HasOne("FIT5032_Assignment_2.Models.NFTsBought", "NFTsBought")
                        .WithMany()
                        .HasForeignKey("Bought_Tx");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "User")
                        .WithMany()
                        .HasForeignKey("OrgId");

                    b.Navigation("NFTsBought");
